...
public class AnyadirAlquileresModel extends Conexion{
    ...
    public void AnyadirAlquiler(Alquileres a) {
        ...
        try {
            ...
            String sql = "INSERT INTO alquileres (Ubicacion, nombre, precio, MetrosCuadrados, imagen,fecha_anyadido, NumHabitaciones, Descripcion, Ciudad,contacto,id_estudiante)VALUES (?, ?, ?, ?, ?, ?, ?,?,?,?,?);";
            ...
            ps.setInt(11,usuactual.getId_usuario());
