...
//
    public ArrayList<Alquileres> mostrarAlquileresPorUsuario(Usuario usuario) {
        ...
        try {
            String sql = "SELECT Ubicacion, nombre, precio, MetrosCuadrados, imagen, NumHabitaciones, Descripcion, Ciudad FROM alquileres where id_estudiante = ? ORDER BY fecha_anyadido DESC;";
            PreparedStatement ps = this.getConexion().prepareStatement(sql);
